...
const getBaseUrl = () => {
  ...
  // Fallback for mobile if env is missing.
  // NOTE: Do NOT include /api here — the generated client already appends /api/tasks etc.
  return "https://to-do-list-tloc.onrender.com";
};
